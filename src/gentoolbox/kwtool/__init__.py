...
__productname__ = "kwtool"
__authors__ = (
    'Karl Trygve Kalleberg - Original author of kwtool',
    'Douglas Anderson - 0.3.0 author of kwtool',
    'Max Hacking - author of kwtool (this!)'
)
...
def initialize_configuration():
    """Setup the standard kwtool config"""
...
def main_usage():
    """Return the main usage message for kwtool"""
